# NetEase-Translation ![TravisBuild](https://api.travis-ci.org/felix3008/NetEase-Translation.svg?branch=master)
...
The repository now has both 3.0.1 versions and 2.5.4 versions. The newest version will always be in the master branch while older versions have their own branches (e.g. 254).
