...
# static fields
.field public static final a:Ljava/lang/String; = "download.db"

.field public static final b:I = 0x5

.field private static final c:Ljava/lang/String;

.field private static final d:Ljava/lang/String; = "download_track_info"

.field private static final e:Ljava/lang/String; = "download_program_info"
...
.method static constructor <clinit>()V
    ...
    sput-object v0, Lcom/netease/cloudmusic/service/download/a;->c:Ljava/lang/String;
...
.method public constructor <init>(Landroid/content/Context;)V
    ...
    iput-object v0, p0, Lcom/netease/cloudmusic/service/download/a;->h:Landroid/database/sqlite/SQLiteDatabase;

    .line 30
    iget-object v0, p0, Lcom/netease/cloudmusic/service/download/a;->h:Landroid/database/sqlite/SQLiteDatabase;
...
.method private b(Landroid/database/Cursor;)Lcom/netease/cloudmusic/meta/virtual/LocalProgram;
    ...
    .line 130
    invoke-static {v4}, Lcom/netease/cloudmusic/k;->j(Ljava/lang/String;)Ljava/lang/String;
...
.method private d()V
    ...
    const-string v1, "CREATE TABLE IF NOT EXISTS download_track_info(track_id INTEGER, doc_id INTEGER, music_name VARCHAR, singer_name VARCHAR, bit_rate INTEGER, type INTEGER, album_name VARCHAR, covers VARCHAR, duration INTEGER, artist_id INTEGER, album_id INTEGER, filesize INTEGER, state INTEGER, mv_id INTEGER, time INTEGER, file_name VARCHAR, PRIMARY KEY(type, track_id))"
    ...
    const-string v1, "CREATE INDEX IF NOT EXISTS filename_index ON %s (file_name)"
    ...
    const-string v4, "download_track_info"
...
.method public a()Ljava/util/ArrayList;
    ...
    const-string v3, "SELECT * FROM download_track_info WHERE type=?"
...
.method public b()Ljava/util/ArrayList;
    ...
    const-string v3, "SELECT * FROM download_program_info"
...
.method public onUpgrade(Landroid/database/sqlite/SQLiteDatabase;II)V
    ...
    .line 166
    :pswitch_0
    sget-object v1, Lcom/netease/cloudmusic/service/download/a;->c:Ljava/lang/String;

    const-string v2, "onUpgrade,currentVersion:2"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 167
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN duration INTEGER"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 168
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN artist_id INTEGER"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 169
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN album_id INTEGER"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 170
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN filesize INTEGER"
    ...
    const-string v2, "onUpgrade,currentVersion:3"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 174
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN state INTEGER DEFAULT 0"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 175
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN mv_id INTEGER"

    invoke-virtual {p1, v1}, Landroid/database/sqlite/SQLiteDatabase;->execSQL(Ljava/lang/String;)V

    .line 176
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN time INTEGER"
    ...
    const-string v2, "onUpgrade,currentVersion:4"

    invoke-static {v1, v2}, Landroid/util/Log;->d(Ljava/lang/String;Ljava/lang/String;)I

    .line 181
    const-string v1, "ALTER TABLE download_track_info ADD COLUMN file_name VARCHAR"
    ...
    const-string v2, "onUpgrade,currentVersion:5"
