...
.field private final mMenu:Landroid/support/v7/internal/view/menu/a;
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;)V
    .locals 6
    ...
    invoke-direct/range {v0 .. v5}, Landroid/support/v7/internal/view/menu/MenuPopupHelper;-><init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;Landroid/view/View;ZI)V

    .line 81
    return-void
.end method

.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;Landroid/view/View;)V
    .locals 6
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;Landroid/view/View;ZI)V
    .locals 7
...
.method public constructor <init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;Landroid/view/View;ZII)V
    .locals 3
    ...
    .line 96
    iput-object p2, p0, Landroid/support/v7/internal/view/menu/MenuPopupHelper;->mMenu:Landroid/support/v7/internal/view/menu/a;

    .line 97
    new-instance v0, Landroid/support/v7/internal/view/menu/MenuPopupHelper$MenuAdapter;

    iget-object v1, p0, Landroid/support/v7/internal/view/menu/MenuPopupHelper;->mMenu:Landroid/support/v7/internal/view/menu/a;

    invoke-direct {v0, p0, v1}, Landroid/support/v7/internal/view/menu/MenuPopupHelper$MenuAdapter;-><init>(Landroid/support/v7/internal/view/menu/MenuPopupHelper;Landroid/support/v7/internal/view/menu/a;)V
    ...
    .line 109
    invoke-virtual {p2, p0, p1}, Landroid/support/v7/internal/view/menu/a;->addMenuPresenter(Landroid/support/v7/internal/view/menu/MenuPresenter;Landroid/content/Context;)V
...
.method static synthetic access$300(Landroid/support/v7/internal/view/menu/MenuPopupHelper;)Landroid/support/v7/internal/view/menu/a;
    .locals 1

    .prologue
    .line 45
    iget-object v0, p0, Landroid/support/v7/internal/view/menu/MenuPopupHelper;->mMenu:Landroid/support/v7/internal/view/menu/a;
...
.method public onDismiss()V
    ...
    invoke-virtual {v0}, Landroid/support/v7/internal/view/menu/a;->close()V
...
.method public onItemClick(Landroid/widget/AdapterView;Landroid/view/View;IJ)V
    ...
    .line 191
    # getter for: Landroid/support/v7/internal/view/menu/MenuPopupHelper$MenuAdapter;->mAdapterMenu:Landroid/support/v7/internal/view/menu/a;
    invoke-static {v0}, Landroid/support/v7/internal/view/menu/MenuPopupHelper$MenuAdapter;->access$000(Landroid/support/v7/internal/view/menu/MenuPopupHelper$MenuAdapter;)Landroid/support/v7/internal/view/menu/a;
    ...
    invoke-virtual {v1, v0, v2}, Landroid/support/v7/internal/view/menu/a;->performItemAction(Landroid/view/MenuItem;I)Z
...
.method public onSubMenuSelected(Landroid/support/v7/internal/view/menu/d;)Z
    ...
    invoke-direct {v3, v0, p1, v4}, Landroid/support/v7/internal/view/menu/MenuPopupHelper;-><init>(Landroid/content/Context;Landroid/support/v7/internal/view/menu/a;Landroid/view/View;)V
    ...
    invoke-interface {v0, p1}, Landroid/support/v7/internal/view/menu/MenuPresenter$Callback;->onOpenSubMenu(Landroid/support/v7/internal/view/menu/a;)Z
